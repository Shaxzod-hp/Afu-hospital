  ...
  <div class="news-form-page">
    ...
    >
      <div class="d-flex align-items-center gap-3">
        ...
        <h3 class="m-0 fw-800 text-dark-slate">Yangilikni tahrirlash</h3>
      </div>
    </div>

    <!-- Loading -->
    <div v-if="loadingData" class="glass-panel p-5 text-center">
      <div class="spinner-border text-primary" role="status"></div>
    </div>

    <!-- Form Container -->
    <div v-else class="glass-panel p-4 p-md-5">
