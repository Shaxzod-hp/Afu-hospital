  ...
  <section class="section-pad py-5">
    <div class="mx-3 mx-lg-5">
      ...
      <div class="position-relative px-0 px-md-4">
            ...
            >
              ...
              >
                ...
                <div class="position-absolute bottom-0 start-0 m-3 z-2">
                  <span
                    class="badge bg-white text-dark rounded-pill px-3 py-2 small fw-medium d-inline-flex align-items-center border"
                  >
              ...
              <div class="p-4 d-flex flex-column flex-grow-1">
                ...
                <router-link
                  ...
                  class="d-inline-flex align-items-center gap-2 text-primary fw-semibold text-decoration-none small mt-auto link-hover"
                >
        ...
        <div v-else-if="store.loading" class="row g-3">
          <div v-for="n in 4" :key="n" class="col-12 col-sm-6 col-lg-3">
            <div class="card border-0 rounded-4 p-3 placeholder-glow">
              <div
                class="placeholder rounded-3 mb-3"
                style="height: 200px"
              ></div>
        ...
        <button class="news-prev news-nav-btn d-flex" aria-label="Oldingi">
          <i class="bi bi-chevron-left"></i>
        </button>
        <button class="news-next news-nav-btn d-flex" aria-label="Keyingi">
...
const getImageUrl = (imagePath) => {
  ...
  // Agar path boshida slash (/) bo'lmasa, qo'shamiz
  let cleanPath = imagePath.startsWith("/") ? imagePath : `/${imagePath}`;

  // (Laravel storage link'dan foydalanganda yo'l odatda /storage/... bilan boshlanishi kerak)
